window.addEventListener('DOMContentLoaded', () => {
    swal({
        ...
        text: `Hola, registrate y recibe un super bono de bienvenida`,
        button: 'Aceptar'
    })
    //--------------------------------------
    //Variables Globales-----------------
    ...
    //para manipular el modal de iniciar sesion y de registro se utiliza la libreria bootstrap
    ...
    var txtCantVenderPen = document.getElementById('txtCantVenderPen');
    ...
    function limpiaDatos () {
        ...
        lblPrecioCompra.innerText="";
        lblPrecioVenta.innerText="";
    ...
    function calcularVenta(){
        ...
        switch(find){
            case 'BTC':
                recuperado = JSON.parse(localStorage.getItem('BTC-PEN'));
                txtCantVenderPen.value = txtCantVender.value * recuperado.max_bid[0];
                lblPrecioVenta.innerText = `El precio de venta es: ${recuperado.max_bid[0]} PEN\n\nDespues de la venta tendras en tu billetera:`;
                break;
            case 'ETH':
                recuperado = JSON.parse(localStorage.getItem('ETH-PEN'));
                txtCantVenderPen.value = txtCantVender.value * recuperado.max_bid[0];
    ...
    rdoButtonsComprar.forEach(rdoButton=>{
        rdoButton.addEventListener('change',limpiaDatos)});
